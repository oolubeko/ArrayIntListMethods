...
public class ArrayIntList {
 ...
 // pre : size() < capacity (throws IllegalStateException if not) &&
    ...
    //This method accepts an integer as a parameter and returns the index of the 
    //last occurrence of that value, or -1 if the value doesn't exist
    ...
    //This method accepts two integers as parameters and replaces all occurrences 
    //of the first value with the second value
